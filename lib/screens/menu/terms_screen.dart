    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSection(
            '제5조 (서비스의 제공)',
            '서비스는 다음과 같은 서비스를 제공합니다.\n\n1. 제주 오름 정보 제공\n2. GPS 기반 스탬프 인증\n3. 등산로 안내 및 실시간 경로 추적\n4. 등산 기록 저장 (경로, 거리, 시간, 걸음수, 칼로리, 고도 등)\n5. 등산 중 사진 촬영 및 위치 기반 기록\n6. 커뮤니티 서비스\n7. 랭킹 서비스\n8. 기타 서비스가 정하는 서비스',
          ),
          _buildSection(
            '제6조 (회원의 의무)',
          ...
          _buildSection(
            '제7조 (사용자 생성 콘텐츠 정책)',
            '1. 회원은 커뮤니티 게시글, 댓글, 사진 등 사용자 생성 콘텐츠(이하 "UGC")를 게시할 수 있습니다.\n\n'
            '2. 다음에 해당하는 콘텐츠는 절대 허용되지 않으며(무관용 원칙), 발견 즉시 삭제되고 계정이 영구 정지될 수 있습니다.\n'
            '  - 음란물, 선정적 콘텐츠\n'
            '  - 폭력적이거나 위협적인 콘텐츠\n'
            '  - 혐오 발언, 차별적 표현\n'
            '  - 괴롭힘, 따돌림, 스토킹\n'
            ...
            '  - 저작권 등 지식재산권 침해 콘텐츠\n'
            '  - 불법 활동을 조장하는 콘텐츠\n\n'
            '3. 서비스는 부적절한 콘텐츠를 사전 통보 없이 삭제할 수 있으며, 악용 사용자의 계정을 즉시 정지 또는 영구 차단할 수 있습니다.\n\n'
            '4. 회원은 부적절한 콘텐츠를 발견한 경우 앱 내 신고 기능 또는 "문의하기"를 통해 신고할 수 있습니다.\n\n'
            '5. 회원이 게시한 UGC에 대한 책임은 해당 회원에게 있습니다.',
          ),
          _buildSection(
            '제8조 (면책조항)',
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSection(
            ...
            '- 이메일, 닉네임, 프로필 이미지\n\n'
            '■ 등산 서비스 이용 시\n'
            '- GPS 위치정보 (실시간 위치, 이동 경로)\n'
            '- 백그라운드 위치정보 (화면 꺼진 상태에서의 경로 추적)\n'
            '- 신체 활동 정보 (걸음수)\n'
            '- 고도, 이동 거리, 소요 시간, 이동 속도\n'
            '- 소모 칼로리 (걸음수 및 이동 데이터 기반 계산값)\n\n'
            '■ 사진 촬영 시\n'
            '- 촬영한 사진 이미지\n'
            '- 사진 촬영 시점의 GPS 위치정보\n\n'
            '■ 자동 수집항목\n'
          ...
          _buildSection(
            ...
            '- 회원 식별 및 가입의사 확인\n'
            '- 서비스 제공 및 운영\n'
            '- GPS 기반 스탬프 인증 및 등산 기록 저장\n'
            '- 등산 경로 기록 및 통계 제공 (거리, 시간, 걸음수, 칼로리 등)\n'
            '- 등산 중 촬영한 사진의 위치 기반 기록 저장\n'
            '- 랭킹 서비스 제공\n'
            '- 고객 문의 응대\n'
            '- 서비스 개선 및 익명화된 통계 분석\n\n'
            '※ 수집된 개인정보는 위 목적 외의 용도로 사용되지 않으며, 제3자에게 제공하지 않습니다.',
          ),
          _buildSection(
            '3. 개인정보의 보유 및 이용기간',
            '회원의 개인정보는 원칙적으로 개인정보의 수집 및 이용목적이 달성되면 지체없이 파기합니다.\n\n'
            '- 회원 탈퇴 시: 즉시 파기 (단, 부정이용 방지를 위해 이메일은 30일간 보관 후 파기)\n'
            '- 등산 기록 (경로, 사진 등): 회원 탈퇴 시 또는 삭제 요청 시 파기\n\n'
            '단, 관계법령의 규정에 의하여 보존할 필요가 있는 경우:\n'
          ...
          _buildSection(
            '5. 위치정보의 처리',
            '서비스는 다음과 같이 위치정보를 수집·이용합니다.\n\n'
            '■ 포그라운드 위치정보\n'
            '- 수집목적: 스탬프 인증, 등산 경로 기록, 현재 위치 표시\n'
            '- 수집시점: 앱 사용 중 위치 기능 활성화 시\n\n'
            '■ 백그라운드 위치정보\n'
            '- 수집목적: 등산 중 화면을 꺼도 경로가 끊기지 않고 기록되도록 함\n'
            '- 수집시점: 등산 시작 후 ~ 등산 종료 시까지\n'
            '- 종료조건: 등산 완료/중단 시 즉시 백그라운드 위치 수집 중단\n\n'
            '■ 사진 촬영 위치\n'
            '- 수집목적: 등산 중 촬영한 사진의 위치를 경로와 함께 기록\n'
            '- 수집시점: 등산 중 카메라 촬영 시\n\n'
            '회원은 언제든지 기기 설정에서 위치정보 수집을 거부할 수 있으나, 이 경우 등산 기록 및 스탬프 인증 서비스 이용이 제한됩니다.',
          ),
          _buildSection(
            '6. 신체 활동 정보의 처리',
            '서비스는 등산 중 걸음수를 측정하기 위해 신체 활동 정보(활동 인식)를 수집합니다.\n\n'
            '- 수집목적: 등산 걸음수 측정 및 칼로리 계산\n'
            '- 수집시점: 등산 시작 후 ~ 등산 종료 시까지\n'
            '- 보유기간: 등산 기록과 함께 보관\n\n'
            '회원은 신체 활동 권한을 거부할 수 있으며, 이 경우 걸음수 및 칼로리가 기록되지 않습니다.',
          ),
          _buildSection(
            '7. 개인정보의 제3자 제공',
          ...
          _buildSection(
            ...
            '- 가입해지(회원탈퇴) 요청\n'
            '- 개인정보 처리정지 요청\n\n'
            '위 요청은 앱 내 "문의하기"를 통해 가능하며, 요청 접수 후 지체없이 처리합니다.',
          ),
          const SizedBox(height: 32),
        ],
      ),
